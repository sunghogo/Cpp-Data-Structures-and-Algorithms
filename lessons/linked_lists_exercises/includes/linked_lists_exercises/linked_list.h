#ifndef LESSONS_LINKED_EXERCISES_LISTS_INCLUDES_LINKED_LISTS_EXERCISES_LINKED_LIST_H_
#define LESSONS_LINKED_EXERCISES_LISTS_INCLUDES_LINKED_LISTS_EXERCISES_LINKED_LIST_H_

#include <iostream>
#include <memory>
#include "linked_lists_exercises/node.h"
